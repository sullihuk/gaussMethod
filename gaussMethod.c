...
void printer (float system[row][row+1], int params) //Метод выводит на экран матрицу, поступающую на вход как параметр метода
{	
...
{	
  ...
  reverseTriangle(rateAu);// Вызов метода для вычисления обратной матрицы
